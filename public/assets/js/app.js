    ...
    if (mode == "winner") {
        addContent(
            `<div style="text-align:center;font-size: 1.25rem;">
                <div style='padding-bottom:.25rem;'>Right word 🎉🎉🎉</div>
                <div style='padding-bottom:.5rem;font-weight: bold;'>`+userName+`</div>
                <div>
                    <img src="`+userAvatar+`" style="width:128px;height:128px;border-radius: 50%;"/>
                </div>
            </div>`
        );
    } else {
...
function addGift(data) {
    ...
    if (giftTotal >= 10) {
        ...
        addContent(
            `<div style="text-align:center;font-size: 1.25rem;">
                <div style='padding-bottom:.5rem;'>Thank you <span style='font-weight: bold;'>`+userName+`!</span>
                </div>
                <div style='font-weight: bold;padding-bottom:.5rem;'>
                <img src="`+giftPictureUrl+`" style="width:32px;height:32px;"/> Sent `+giftName+`
                </div>
            x`+giftRepeat.toLocaleString()+` worth `+giftTotal.toLocaleString()+` coins!</div>
            <div  style="text-align:center">
                    <img src="`+userAvatar+`" style="width:60px;height:60px;border-radius: 50%;"/>
                </div>`
        );
    ...
    if (giftTotal >= 15){
        addContent(
            `<div style="text-align:center;font-size: 1.25rem;">
                <div style='padding-bottom:.25rem;'> `+giftTotal.toLocaleString()+` of `+giftName+`</div>
                <div style='padding-bottom:.5rem;font-weight: bold;'>`+userName+`</div>
                <div>
                    <img src="`+userAvatar+`" style="width:128px;height:128px;border-radius: 50%;"/>
                </div>
